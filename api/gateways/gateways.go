...
type DatabaseGateway interface {
	...
	CreateThread(ctx context.Context, address string, title string, content string, imageFileName string, imageURL string, imageContentType string) (int64, error)
	...
	CreateComment(ctx context.Context, threadId int64, address string, repliedToCommentId *int64, content string, imageFileName string, imageURL string, imageContentType string) (int64, error)
