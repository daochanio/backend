...
type IDatabaseGateway interface {
	...
	GetThreads(ctx context.Context, offset int64, limit int64) ([]entities.Thread, error)
	...
	CreateComment(ctx context.Context, threadId int64, address string, parentCommentId *int64, content string) (int64, error)
	GetComments(ctx context.Context, threadId int64) ([]entities.Comment, error)
